...
//	
//	// Stores the NetworkInterface of the device that registered for events in this driver
//    private Vector listennerDevices = new Vector();
//    
//    // Display of the middlet in execution
//    private Display display;
//    
//    // Original display of the midlet
//    private Displayable olderDisplayable;
//    
...
//		upService.addParameter(MOUSE_EVENT_PARAM_MOUSE_COMMAND, ParameterType.MANDATORY)
//				.addParameter(MOUSE_EVENT_PARAM_MOVE_FACTOR,
//						ParameterType.MANDATORY);
//		
...
//		gateway = deviceManager.getGateway();
//        display = deviceManager.getDisplay(); 
//        olderDisplayable = display.getCurrent();
