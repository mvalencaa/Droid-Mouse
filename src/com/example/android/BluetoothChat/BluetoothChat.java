...
import br.unb.unbiquitous.ubiquitos.uos.network.bluetooth.BluetoothDevice2;
...
public class BluetoothChat extends Activity {
	...
	// Ver o log do android: adb shell logcat
	...
	private final Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case MESSAGE_READ:
				...
				// TODO Tirar esse numero magico.
				int index = readMessage.indexOf("\n");
				readMessage = readMessage.substring(0, index);

				BluetoothDevice2 clientDevice = new BluetoothDevice2(
						mChatService.getRemoteDevice());
				...
				try {
					...
					deviceDriver.init(mBluetoothAdapter.getName(),
					...
					BluetoothChat.this.sendMessage(jsonResponse.toString());
